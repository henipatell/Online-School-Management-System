<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="sem1.aspx.cs" Inherits="Online_School_Management_System.sem1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="button"><a href="/logout.aspx" accesskey="7" class="menubutton" target="_top" title="">Logout</a></div>
            ...
            <td class="auto-style8">
                <p style="font-style:normal; font-family:Aharoni; z-index: 1; left: 237px; top: 309px; position: absolute; height: 18px; width: 1423px; margin-top: 4px;">Result Of 1st Internal and 2nd Internal :</p>
   
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="LoginId,RollNo,Class" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" style="z-index: 1; left: 230px; top: 404px; position: absolute; height: 181px; width: 999px">
