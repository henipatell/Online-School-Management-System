<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="stdlogin.aspx.cs" Inherits="Online_School_Management_System.stdlogin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" Height="569px" style="margin-top: 0px">
        <p style="font-weight: 100; font-style: normal; font-variant: normal; text-transform: inherit; color: #000000; text-decoration:blink ; font-size: medium; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">NOTE : All the students are informed that Login Id for this site will be his/her ID No., And Password will be his/her Birthdate(Ex:11/01/99).</p>
        <asp:Panel ID="Panel2" runat="server" BackColor="#009999" style="z-index: 1; left: 431px; top: 395px; position: absolute; height: 184px; width: 458px" BorderColor="#CC9900" BorderStyle="Inset" BorderWidth="3px">
            <asp:Panel ID="Panel3" runat="server" BackColor="#CCFFFF" style="z-index: 1; left: 12px; top: 23px; position: absolute; height: 38px; width: 431px">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Panel ID="Panel4" runat="server" BackColor="#CCFFFF" style="z-index: 1; left: 11px; top: 66px; position: absolute; height: 40px; width: 432px">
